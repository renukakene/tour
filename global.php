...
// Base query
$query = "SELECT * FROM `packages` WHERE tour_type = 'global'";
...
<h2 class="text-center mb-4" style="color:#600070;">Global Tour Packages</h2>
    <div class="row">
        <!-- Sidebar Filters -->
        <div class="col-md-3">
        ...
        <div class="col-md-9">    
            <div class="row">
                <h4 align="center">Global Packages</h4>
                <?php 
